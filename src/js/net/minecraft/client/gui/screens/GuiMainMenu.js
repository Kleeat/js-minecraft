...
export default class GuiMainMenu extends GuiScreen {
  ...
  init() {
    ...
    this.buttonList.push(
      new GuiButton('Singleplayer', this.width / 2 - 100, y, 200, 20, () => {
        this.minecraft.displayScreen(new GuiCreateWorld(this))
      }),
    )
    this.buttonList.push(
      new GuiButton('Multiplayer', this.width / 2 - 100, y + 24, 200, 20, () => {
        this.minecraft.displayScreen(new GuiDirectConnect(this))
      }),
    )
    this.buttonList.push(
      new GuiButton('Minecraft Realms', this.width / 2 - 100, y + 24 * 2, 200, 20, () => {}).setEnabled(false),
    )
    this.buttonList.push(
      new GuiButton('Options...', this.width / 2 - 100, y + 72 + 12, 98, 20, () => {
        this.minecraft.displayScreen(new GuiOptions(this))
      }),
    )
    this.buttonList.push(
      new GuiButton('Quit Game', this.width / 2 + 2, y + 72 + 12, 98, 20, () => {
        this.minecraft.stop()
      }),
    )
  ...
  drawScreen(stack, mouseX, mouseY, partialTicks) {
    ...
    this.drawRightString(
      ...
      this.width - 2,
      this.height - 10,
      mouseOver ? 0xff00ffff : 0xffffffff,
    )
