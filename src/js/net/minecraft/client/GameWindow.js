  ...
  registerDesktopListeners() {
    ...
    this.registerListener(document, 'mousedown', (event) => {
      ...
      if (currentScreen !== null) {
        currentScreen.mouseClicked(event.x / this.scaleFactor, event.y / this.scaleFactor, event.code)
      }
    ...
    this.registerListener(
      ...
      (event) => {
        for (let i = 0; i < event.touches.length; i++) {
          ...
          let currentScreen = this.minecraft.currentScreen
          if (currentScreen !== null) {
            currentScreen.mouseClicked(x / this.scaleFactor, y / this.scaleFactor, 0)
          }
    ...
    this.registerListener(
      ...
      (event) => {
        for (let i = 0; i < event.touches.length; i++) {
          ...
          let currentScreen = this.minecraft.currentScreen
          if (currentScreen !== null) {
            currentScreen.mouseDragged(x / this.scaleFactor, y / this.scaleFactor, 0)
          }
    ...
    this.registerListener(
      ...
      (event) => {
        ...
        for (let i = 0; i < event.changedTouches.length; i++) {
          ...
          let currentScreen = this.minecraft.currentScreen
          if (currentScreen !== null) {
            currentScreen.mouseReleased(x / this.scaleFactor, y / this.scaleFactor, 0)
          }
